...
class DownModelProperty:
    ...
    def up_take_100(self):
        return self.t4[1] - (self.t1[1] - self.t4[1]) * 1
    ...
    def target_1(self):
        if self.LT_break_point:
            min_price = self.df['low'].iloc[
                        int(self.t4[0]):int(self.LT_break_point[0])
                        ].min()
            print(min_price)
            dist_t4_lt_break = float(self.LT_break_point[1]) - min_price
    ...
    def target_3(self):
        if self.LT_break_point:
            high_t4_t1 = self.t1[1] - self.t4[1]
    ...
    def target_5(self):
        if self.LT_break_point:
            ...
            print(min_price)
            dist_t4_lt_break = float(self.CP[1]) - min_price
